...
export default class Product extends React.Component{
    constructor(){
        ...
        // login sbg admin atau tidak, karena tidak dapat diakses sembarang user
        ...
        return(
            <div>
                ...
                <div className="container">
                    <h3 className="title wow bounce animated" data-wow-duration="700ms">Product List</h3>
                    <div className="row">
                ...
                <div className="modal fade" id="modal_product">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header bg-primary text-black">
                                <h4>Form Product</h4>
                            </div>
